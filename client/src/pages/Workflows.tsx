    ...
    <>
      ...
      {open && (
        <div
          ref={popoverRef}
          role="tooltip"
          className="fixed z-50 p-3.5 bg-[#0b1a2b] border border-[#153450] rounded-lg shadow-2xl text-[11px] text-gray-300 pointer-events-none"
          style={{ left: coords.left, top: coords.top, width: POPOVER_W }}
        >
          <p className="text-xs font-semibold text-gray-100 mb-2.5 pb-2 border-b border-[#153450]">
            {title}
          </p>
