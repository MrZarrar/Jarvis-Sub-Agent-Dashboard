...
const TIER_ORDER = {
  // Personal Jarvis policy: signed-in subscriptions only. Never cross into
  // API-key billing or local-model routing as an implicit fallback.
  simple: ["codex", "claude"],
  standard: ["codex", "claude"],
  complex: ["claude", "codex"],
};
