 ...
 * Reuses the user's existing `codex login` / ChatGPT subscription instead of
 * requiring an OpenAI API key. Each call is ephemeral and read-only; Mini
 * Jarvis actions continue to flow through its own gated dispatcher rather than
 * through Codex's shell/file tools.
 */
