...
const paths = {
  ...
  "/api/business/amazon/{asin}": {
    get: {
      ...
      parameters: [{ name: "asin", in: "path", required: true, schema: { type: "string" } }],
      responses: {
        200: { description: "Catalog + offers" },
        502: { description: "Upstream error" },
        503: NOT_CONNECTED,
      },
    },
  ...
  "/api/business/ebay/search": {
    get: {
      ...
      responses: {
        200: { description: "Item summaries" },
        400: { description: "q missing" },
        502: { description: "Upstream error" },
        503: NOT_CONNECTED,
      },
    },
  ...
  "/api/business/ebay/listing": {
    post: {
      ...
      responses: {
        200: { description: "Draft created (published: false)" },
        502: { description: "Upstream error" },
        503: NOT_CONNECTED,
      },
    },
  ...
  "/api/analytics/codex/limits": {
    get: {
      ...
      responses: {
        200: { description: "Native Codex rate-limit windows" },
        503: { description: "Codex app-server unavailable" },
      },
    },
  },
};
