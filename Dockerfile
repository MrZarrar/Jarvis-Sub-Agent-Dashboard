# Multi-stage Dockerfile for Jarvis Agentic OS - a Node.js server with a React client.
...
#
# Original container setup by Son Nguyen; maintained as part of Jarvis Agentic OS.
